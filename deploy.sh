...
echo "     MINECRAFT_PORT=25565"
echo ""
echo "🌐 Bot Server URL (after deploy):"
echo "  https://donutbets-bot-manager.onrender.com"
echo ""
echo "📊 Monitor deployment at:"
echo "  https://dashboard.render.com"
echo ""
echo "🎯 Test commands:"
echo "  curl https://donutbets-bot-manager.onrender.com/health"
echo "  curl -X POST https://donutbets-bot-manager.onrender.com/api/start_bot \\"
echo "    -H \"Content-Type: application/json\" \\"
echo "    -d '{\"bot_name\":\"test_bot\", \"server\":\"server1\"}'"
echo ""
echo "🔗 Weboldal config.php frissítése:"
echo "  define('BOT_SERVER_HOST', 'donutbets-bot-manager.onrender.com');"
echo "  define('BOT_SERVER_PORT', 443);"
echo ""
